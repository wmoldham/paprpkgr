...
project.
1. Original data goes into the `inst/extdata` folder.
1. Analyze the raw data and generate cleaned data for analysis using Rmarkdown
files in `inst/analysis/`. Figures from these analyses should be saved in
...
`inst/manususcript/`. 
1. Edit the `Makefile` to link raw data, analysis scripts, final data, manuscript, 
and figures. 
